...
## � Paso 1.5: Instalar Librerías del Sistema (CRÍTICO para Ubuntu/Debian)

Para que WhatsApp Web funcione y pueda generar el QR, **es obligatorio** instalar estas librerías del sistema que `npm` no puede instalar. Sin esto, el sistema se quedará en "Conectando..." infinitamente.

**Copia y pega este comando en tu terminal SSH (una sola vez):**
